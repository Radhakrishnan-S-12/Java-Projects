...
public class TweetAppController {
	...
	public String updatePassword(@PathVariable String username, @PathVariable String oldPassword,
	...
	public String updateTweetMessage(@PathVariable String username, @PathVariable String id,
